...
public class UniverseDelegationExtension extends SimpleExtension<SExpression, Universe> {

	private static final ModalExpression DELEGATION = new Delegation(new TermVariable("master"), new ExpressionVariable("goal"), new TermVariable("master"));
	
	public UniverseDelegationExtension(){
	...
	public void parse(SExpression document, Parser<SExpression> parser) throws ParseException {
		...
		modalities[modalities.length - 1] = DELEGATION;
